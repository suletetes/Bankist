...
const displayMovements = function (acc, sort = false) {
  ...
  // const sortDsc = ((a,b) =>  b-a)
  // const sortAsc = ((a, b) => a - b)
  // const movs = sort ? movements.slice().sort(sortAsc) : movements.slice().sort(sortDsc);
  // sort = true Asc sort=false Dsc
  const movs = sort
...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // when o seconds, stop the timer and logout timer
    if (time === 0) {
      clearInterval(timer);
...
let sorted = false;
let arrowUp = '&uparrow; SORT';
let arrowDown = '&downarrow; SORT';
...
// LECTURES
/*
// console.log(Number.parseInt('34567fgfh'));
